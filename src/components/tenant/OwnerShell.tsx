...
export function OwnerShell({ title, subtitle, schoolSlug, children }: Props) {
  ...
  const navItems = [
    ...
    { to: `${basePath}/exams`, icon: FileText, label: "Exams" },
    { to: `${basePath}/diary`, icon: BookOpen, label: "Diary" },
    { to: `${basePath}/notice-board`, icon: Megaphone, label: "Notice Board" },
    { to: `${basePath}/holidays`, icon: Sun, label: "Holidays" },
    { to: `${basePath}/fee-slips`, icon: Receipt, label: "Fee Slips" },
